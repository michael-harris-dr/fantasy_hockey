...
#TODO: trim NHL_TEAMS.json
def update_team_list():
#UNUSED (formerly used the below code but the new teams list returns defunct teams so a new unchanging reference json has been made)
    #if(True):
...
def populate_stats(playerIDs, yearStrings):
    ...
    playerStats = {}
    for years in yearStrings:"https://api-web.nhle.com/v1/player/8479318/landing"
